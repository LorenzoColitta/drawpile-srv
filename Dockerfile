...
RUN apt-get update && apt-get install -y wget curl libfuse2 libgl1 libglib2.0-0 libfontconfig1 libdbus-1-3 libicu70 ca-certificates sqlite3 procps && rm -rf /var/lib/apt/lists/*
...
COPY --chown=drawpile:drawpile templates /home/drawpile/templates
